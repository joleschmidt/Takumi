  ...
  return (
    <>
      <div className="relative w-full max-w-2xl mx-auto">
        <div
          className="relative w-full aspect-[4/4.7] shadow-2xl shadow-black/5 bg-white overflow-hidden group cursor-pointer"
        ...
        >
          ...
          {/* Fullscreen Button */}
          <div className="absolute top-4 right-4 bg-black/70 hover:bg-black text-white p-2 rounded-full transition-colors z-10">
          ...
          {images.length > 1 && (
            <>
              ...
              {/* Image Counter */}
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black/50 text-white px-4 py-2 rounded-full text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div className="flex gap-2 justify-center overflow-x-auto pb-2">
                  {images.map((img, index) => (
                    <button
                      ...
                      className={`relative w-16 h-16 flex-shrink-0 border-2 transition-all ${index === currentIndex
      ...
      {/* Fullscreen Modal via portal so it sits above Navbar stacking context */}
      {mounted &&
        isFullscreen &&
