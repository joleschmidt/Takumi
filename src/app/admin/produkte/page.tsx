    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {products?.map((product) => (
          <div key={product.id} className="border-2 border-black bg-white group hover:bg-black hover:text-white transition-all duration-300">
            <div className="relative aspect-[4/5] bg-[#F5F5F0] overflow-hidden border-b-2 border-black">
              {product.image_url ? (
                <Image
            ...
            <div className="p-6">
              ...
              <p className="text-sm font-bold mb-4">{product.price_range}</p>
              ...
              <div className="flex gap-2">
                ...
                <form action={`/admin/produkte/${product.id}/delete`} method="POST" className="flex-1">
                  <Button 
                    type="submit"
                    variant="outline"
